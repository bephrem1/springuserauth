...
@Configuration
@EnableJpaRepositories(basePackages = "com.teamtreehouse.todotoday.dao") //Tell spring where out DAO's are
@PropertySource("application.properties") //This points to where the properties loaded into "env" Environment variable are
